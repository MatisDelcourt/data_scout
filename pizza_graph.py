...
fig.text(
    0.515, 0.955,
    "Rang de Percentile vs Milieux centraux du top 7 européen | 2022/2023",
    size=9.5,
    ha="center", color="#ffffff"
)
...
CREDIT_4 = "Uniquement les joueurs avec 1000+ minutes joués en 2022-2023"
# CREDIT_5 = "Ligues européennes de l'échantillon : Top 5 européen, Pays-Bas, Autriche, Portugal"
fig.text(
...
# add text
fig.text(
    0.34, 0.9275, "Attaque       Possession     Défense", size=14, color="#F2F2F2"
)
