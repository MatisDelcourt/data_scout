...
class Radar:
    ...
    def plot_radar(self, ranges, params, values, radar_color, filename=None, dpi=300,
                   ...
                   end_size=9, end_color="#95919B", image_1=None, image_coord_1=None, image_2=None, image_coord_2=None,
                   image_3=None, image_coord_3=None,figax=None, logo=None, logo_coord=None, **kwargs):
        """
        ...
        ## add explanations
        ax.text(-22, -23.5,
                '\nLe cercle intérieur représente le 5ème centile\nLe cercle extérieur représente le 95eme centile',
        ...
        if image_3 != None and image_coord_3 != None:
            fig = add_image(image_3, fig, image_coord_3[0], image_coord_3[1], image_coord_3[2], image_coord_3[3],
                            **kwargs)
    ...
    def __plot_titles(self, ax, title):
        ...
        if title.get('title_name') and title.get('title_name_2') == None:
            ## plot the title name
            ax.text(-13, 24, title['title_name'], fontsize=title['title_fontsize'], fontweight='bold',
                    fontdict={'color': title['title_color']}, fontfamily=self.fontfamily)

        if title.get('subtitle_name') and title.get('title_name_2') == None:
            ## plot the title name
            ax.text(-11.5, 22, title['subtitle_name'], fontsize=title['subtitle_fontsize'],
        ...
        if title.get('title_name_2'):
            ...
            ax.text(-17.2, 24, title['title_name'], fontsize=title['title_fontsize'], fontweight='bold',
                    fontdict={'color': title['title_color']}, fontfamily=self.fontfamily)
            ax.text(16.2, 24, title['title_name_2'], fontsize=title['title_fontsize_2'], fontweight='bold',
        ...
        if title.get('subtitle_name_2'):
            ...
            ax.text(-17.2, 22, title['subtitle_name'], fontsize=title['subtitle_fontsize'],
                    fontdict={'color': title['subtitle_color']}, fontfamily=self.fontfamily)
            ax.text(16.2, 22, title['subtitle_name_2'], fontsize=title['subtitle_fontsize_2'],
